...
/**
 * @author Yash Pratap Singh (Emre1s)
 *                                  Apache License
...
Copyright [2019] [Yash Pratap Singh]
...
object MediaPlaybackUtilility {
    ...
    /**
     * Custom scroll listener for handling auto media playback.
     */
    ...
    /**
     * @param exoPlayer - Attach to first video and play video if the view is video view
     * @param recyclerView - Used to find the current active view
     *
     * Call this method after the recyclerview has received data
     */
